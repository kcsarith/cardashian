...
import { Button, Row, Card, Col, Typography, Divider } from 'antd'
    ...
    return (
        <>
            ...
            <Row style={{ justifyContent: 'center', alignItems: 'center', marginTop: '3em' }}>
                <Col span={8} >
                    <Typography.Title style={{ textAlign: 'center' }} level={3}>Top Picks</Typography.Title>
                    <ImageGallery items={images} thumbnailPosition='right' showBullets autoPlay slideDuration={400} slideInterval={1000} onSlide={handleSlide} />
                </Col>
                <Col span={4}>
